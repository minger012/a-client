export default {
  ...
  agentInvite: {
    ...
    dialogTitle: "Plan Follow",
    dialogPlaceholder: "Please enter the agent ID",
  ...
  realname: {
    ...
    approvedTip: "Your verification has been approved",
    realName: "Real Name",
    ...
    validation: {
      ...
      frontImageRequired: "Please upload front image",
      backImageRequired: "Please upload back image",
    },
    tips: {
      title: "Warm Tips",
      tip1: "Please ensure the certificate information is clear and complete",
      tip2: "Approved verification cannot be modified",
      tip3: "Rejected applications can be resubmitted",
    },
  },
};
